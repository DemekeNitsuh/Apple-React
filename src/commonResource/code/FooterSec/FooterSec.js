            ...
            <div className="container"> 
                ...
                <div className="footer-links-wrapper row"> 
                    ...
                    <h3>Shop and Learn</h3>
                       <Common2  linkName1="Mac"linkName2="iPad"linkName3="iPhone"linkName4="Watch"linkName5="TV"linkName6="Music"linkName7="AirPods"linkName8="HomePod"linkName9="iPod touch"linkName10="Accessories"linkName11="Gift Cards"/> 
                    </div> 

                    <div className="links-wrapper-2 col-sm-12 col-md">
                    <h3>Services</h3>
                     	<Common2 linkName1="Apple Music"linkName2="Apple News+"linkName3="Apple TV+"linkName4="Apple Arcade"linkName5="Apple Card"linkName6="iCloud"/>
                         <h3>Account</h3>			
                     	<Common2  linkName1="Manage Your Apple ID"linkName2="Apple Store Account"linkName3="iCloud.com"/>				
                    </div> 

                    <div className="links-wrapper-3 col-sm-12 col-md">
                    <h3>Apple Store</h3>
                        <Common2  linkName1="Find a Store"linkName2="Genius Bar"linkName3="Today at Apple"linkName4="Apple Camp"linkName5="Field Trip"linkName6="Apple Store App"linkName7="Refurbished and Clearance"linkName8="Financing"linkName9="Financing"linkName10="Order Status"linkName11="Shopping Help"/> 
                    </div>  

                    <div className="links-wrapper-4 col-sm-12 col-md">
                    <h3>For Business</h3>
                        <Common2  linkName1="Apple and Business"linkName2="Shop for Business"/> 
                        <h3>For Education</h3>
                        <Common2 linkName1="Apple and Business"linkName2="Shop for College"/> 
                        <h3>For Healthcare</h3>
                        <Common2  linkName1="Manage Your Apple ID"linkName2="Apple Store Account"linkName3="iCloud.com"/> 
                        <h3>For Government</h3>

                        <Common2 headerName="For Government" linkName1="Apple and Business"linkName2="Shop for College"/> 
                    </div> 

                    <div className="links-wrapper-5 col-sm-12 col-md">
                    <h3>Apple Values</h3>
                    <Common2  linkName1="Apple Values"linkName2="Genius Bar"linkName3="Today at Apple"linkName4="Apple Camp"linkName5="Field Trip"linkName6="Apple Store App"/> 
                    <h3>About Apple</h3>
                    <Common2  linkName1="Find a Store"linkName2="Genius Bar"linkName3="Today at Apple"linkName4="Apple Camp"linkName5="Field Trip"linkName6="Apple Store App"/> 	
                    </div> 
                </div>
